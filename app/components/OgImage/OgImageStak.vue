...
withDefaults(
  ...
  {
    title: "StakOprichten.nl",
    description: "Een STAK oprichten doe je snel en betrouwbaar met StakOprichten.nl",
  },
);
</script>
...
<template>
  <div class="h-full w-full bg-white">
    <h1 class="pl-12 pt-6">StakOprichten.nl</h1>
    <svg
    ...
    <svg
      class="absolute bottom-0 right-0 opacity-35"
      style="z-index: 0"
      width="825"
      height="505"
      viewBox="0 0 825 505"
    ...
    <div class="p-12">
      <div class="relative z-10 mt-16 flex h-full flex-col">
        <div>
          <h1 class="mb-12 text-7xl text-slate-900">
            {{ title }}
          </h1>
          <div
            class="max-w-4xl text-5xl/snug text-slate-700"
            style="
              font-family:
                Inter,
                ui-sans-serif,
